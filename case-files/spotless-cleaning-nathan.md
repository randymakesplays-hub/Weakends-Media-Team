# Case File — Spotless Cleaning Services 336 LLC (Nathan)

**Status:** Live and recoverable — **the Sep 16 "no-show" is most likely Randy's scheduling error, not a flake**
**Owner:** Randy Wilson | Weakends Agency
**Industry:** Cleaning — Winston-Salem, NC (Forsyth County / the Triad)
**Last contact:** Sep 16, 2026, 7:58 AM — an outbound/inbound call lasting **0:07**
**Last conversation:** Sep 15, 2026, ~1:31 PM — 3:03, booked
**Deal type:** Website rebuild + management. **Demand-side — the only NC account in the set**
**Intake-doc classification:** *"responded, flaked on today's call… minimal feedback so far. Need: TBD (discovery incomplete)"* — **two of those three claims do not survive the record. Corrected below.**
...
| Field | Value |
|---|---|
| First name | **Nathan** — given on first ask, no hesitation. **The CRM first-name field currently reads "Spotless cleaning services 336 llc"** |
...
| Source | **Blank in CRM — fix: cold SMS, nc-outreach / triad-part1 list** |
| Owner | **Unassigned — fix: assign to Randy** |

> ⚠️ **This is the NC outreach list, not the Houston one.** Pete, Ooh Wee, Flawless, Jose and Aaron all came off `houston-part1`. Nathan is the only account in the current set sourced from `triad-part1`, and the only one where Randy's own North Carolina background is in play.

---

## Records attached

- Call recording: **3:03**, Sep 15, 2026, ~1:31 PM (Randy opens *"Hey, good afternoon"* — consistent)
- Transcript: `case-files/transcripts/2026-09-15-spotless-cleaning-nathan-raw.txt`
- SMS thread (GHL) — full sequence:

| When | Message |
|---|---|
| Sep 7, 11:47 AM | **Randy:** *"Hey, I was on Google earlier and your site wasn't loading. Everything good?"* |
| Sep 7 | **Nathan:** *"Who this"* |
| Sep 7 | **Randy:** *"Yeah so my name is Randy, I work with a few local businesses and help them scale by managing their systems."* |
| Sep 7 | **Randy:** *"Let me design you a high converting website to capture your businesses services and value so you can convert more clients, sounds like a plan?"* |
| **Sep 15, ~1:31 PM** | **The 3:03 call. Books a noon Sep 16 appointment.** |
| Sep 16, 7:11 AM | **Randy:** *"just touching base making sure we're still good for our call coming up in about an hour and a half"* |
...
Randy opened on the standard hook and immediately did the one thing that separates this call from every other cold call in the portfolio — he made it local:

> **Randy:** *"Real quick, I'm just a small town guy from Five Fork, North Carolina. Um, I work with a lot of local businesses, uh, in North Carolina. I noticed that your company doesn't have any website or doing any, like, media."*

("Five Fork" is as transcribed; likely *Five Forks*. Not worth re-quoting to Nathan without confirming.)

Nathan's first words after *"Yes, sir"* were not a rejection — they were a **request for clarification**:

> **Nathan:** *"You said come in and do what?"*

That is a different animal from Pete's five refusals or Ooh Wee's *"Why y'all keep calling me, bro?"* He didn't push back. He asked what the offer was. Randy ran the pitch:

> **Randy:** *"So I'm doing a performance trial where I'm literally automating your business, building you a website, you know, let's say seven to like ten days. And if you like it, cool, we can make something happen. If not, you know, wipe our hands clean, you know, see you at the top kind of thing."*

Nathan's second turn is the only skeptical note in the entire call, and it is mild:

> **Nathan:** *"Yeah. So you say you just, you just go ahead and start working up front?"*

> **Randy:** *"Yeah, start working up front."*

Randy then asked for a demo call — and justified it with *"'cause like right now I don't have like a website or anything where it has, uh, all your services."* That sentence is what cracked the call open, because it prompted Nathan to volunteer, unasked, the most important fact in this file:

> **Nathan:** *"Yeah, I had a, I had a website, but they took it down, man."*
...
Then the booking — and **this exchange is the whole reconciliation problem**, so it is worth reading slowly:

> **Randy:** *"Nathan, do you have any availability later this evening?"*
> **Nathan:** *"Not today."*
> **Randy:** *"…I can just punch it in for you. **What time works best for you tomorrow morning?**"*
> **Nathan:** *"Uh, **I work in the morning**, so I'll probably be free at noon."*
> **Randy:** *"Noon?"*
> **Nathan:** *"Uh-huh."*
...
## Reconciling the timeline — what most likely happened on Sep 16

The record contains a straight contradiction. Laid out:

| Source | Says the call is at |
|---|---|
| **The Sep 15 transcript** — Nathan's words, Randy's readback, twice | **12:00 noon** |
| Randy's 7:11 AM text — *"coming up in about an hour and a half"* | **~8:41 AM** |
| Randy's 7:46 AM text — *"in about 45 minutes"* | **~8:31 AM** |
| The actual dial | **7:58 AM** |

The two reminder texts agree with each other (~8:31–8:41) and disagree with the transcript by **roughly three and a half hours**. The dial at 7:58 AM is earlier still — **33 minutes before even Randy's own stated time.**

**Timezone does not explain this.** Winston-Salem is Eastern; Randy runs a 346 (Houston) business line alongside a 704 (Charlotte) personal line, so a CT/ET mix-up is plausible in principle — but it is worth at most one hour, and no arithmetic turns "7:11 AM plus an hour and a half" into noon. Both reminders are internally consistent, sent 35 minutes apart, and were followed by a real dial. This is not loose phrasing.
...
**What this means for "flaked."** Nathan told Randy, in plain words, *"I work in the morning."* Randy then texted him twice and called him once **inside the exact window Nathan had said he would be working**, and the appointment he actually agreed to had not yet arrived. The 0:07 call is consistent with ringing out to voicemail or being declined by a man on a job. **There is no evidence in this file that Nathan missed anything.** The record ends at 7:58 AM; whether anyone dialed at noon is unknown.

**This is the single most important correction in the file.** The intake doc's *"flaked on today's call"* assigns the failure to the prospect. On the evidence available it belongs to the agency.

**What would confirm it:** the GHL appointment record (what time was actually saved), the booking-confirmation email in the spotlesscleaningservices336@gmail.com thread (what time Nathan was told), and the call log's direction and disposition for the 7:58 AM 0:07 entry.

---

## Diagnosis

### The lapsed-payment detail changes the entire pitch
...
**The `case-files/README.md` classifies him under "Demand."** That is a reasonable working assumption and it is **not yet evidenced**. Nathan said he lost a website. He never once said he needs more work. Those are different claims, and the portfolio has already been burned by treating the first as proof of the second — see Ooh Wee, where Randy's pitch was recorded in the intake doc as the prospect's stated need. **Hold "demand-constrained" as a hypothesis until he answers a volume question.**

### The intake doc, point by point
...
- **The local play.** *"Small town guy from Five Fork, North Carolina"* → *"my sister used to go to the university over there"* → *"Really all of Forsyth County."* Randy is the only person in this portfolio who can run that angle, and it turned a cold dial into a booking in three minutes. It should be the standard opener on the entire `nc-outreach` list.
- **The pretext was true this time.** *"I was on Google earlier and your site wasn't loading"* was accurate — the site had been taken down — and Nathan confirmed it himself, unprompted. This is the second account where the opener converts because the claim happens to be true (see Alec/Flawless) against one where it cost credibility because it wasn't (Ooh Wee).
- **He got the name on the first ask.** Compare Ooh Wee, asked twice, never given.
- **He did not oversell.** Three minutes, one offer, one booking, off the phone. Against Ooh Wee's 4:05 of monologue this is a better-run call.
...
## Objections raised (and their status)

The honest finding is that **Nathan raised no real objections.** That is itself the strongest qualification signal in the file — and it is why the account is worth chasing hard.

| # | Nathan's words | What it actually was | Randy's response | Status |
|---|---|---|---|---|
| 1 | *"You said come in and do what?"* | **Not an objection** — a request to repeat the offer. Interest, not resistance | Re-ran the performance-trial pitch | **Resolved** |
| 2 | *"So you say you just, you just go ahead and start working up front?"* | Mild skepticism about free work. The only doubt expressed in the call | *"Yeah, start working up front."* — flat confirmation, no proof, no case study, no reason why | **Nominally accepted, untested.** Expect it again on the next call, harder. Have an answer: the Chiquita spec-build is the precedent |
| 3 | *"Not today."* | Availability, not resistance | Moved to tomorrow | **Resolved** |
| 4 | *"I work in the morning, so I'll probably be free at noon."* | A constraint, stated plainly | Confirmed it verbally — **then violated it the next morning** | **Randy's failure, not an objection** |
| — | Price | **Never raised.** Nathan never asked what it costs | Randy pre-emptively removed it (*"you don't pay any monthly fees"*) | **The prospect did not need this concession and did not ask for it** |
...
4. **The old domain's status is unknown and nobody has checked.** *"I can't find it. I can't get it no more. It expired."* Whether the domain is expired-and-available, held by the registrar in redemption, parked, or resold is unknown. Whether he ever controlled it is unknown. The old host is unknown.
   *Failure scenario:* Randy builds a beautiful site on a new domain while Nathan's old URL — the one on his vehicle, his invoices, his flyers and any Google listing — sits dead or, worse, in someone else's hands. **Check the domain before building anything.** Also worth checking: the Google Business Profile, and whether the old site's content and photos are recoverable from an archive. Handing him back his own lost content is the cheapest trust-builder available and costs an hour.
5. **The email has never been proven to work — and that is a second, independent explanation of the missed call.** It is marked unverified in the CRM, it was captured verbally with a garbled readback (*"Spotless Cleaning Services 336@gmail.com. .gmail.com."*), and nothing on file shows a send.
...
- [ ] **Check the clock before doing anything else.** Nathan booked **noon ET today, Sep 16**. If noon has not yet passed, **call at noon** — that is the appointment he actually agreed to, and keeping it converts the whole incident into a non-event
- [ ] **If noon has passed: text first, and own the error.** No blame, no "we missed each other." Something like — *"Nathan, my fault. You told me noon and I had us down for the morning. That's on me. Are you good for noon tomorrow?"* One apology, one specific time, one question
- [ ] **Pull the GHL appointment record and the booking email** — find out what time was actually saved and what time Nathan was actually told. This determines whether the fix is a calendar setting or a habit
- [ ] **Check the 7:58 AM call log direction.** If that 0:07 was *inbound* — Nathan calling back — the recovery is urgent and the "flake" reading is not just wrong, it is backwards
- [ ] **Correct the intake doc.** "Flaked on today's call" → *"agency scheduling error; appointment was noon, contact attempted ~8 AM."* "Minimal feedback so far" → *"name, city, prior site, prior spend, cause of loss and availability all captured in 3:03"*
- [ ] **Before the next call, look up:** the old domain's registration status, the Google Business Profile, and any archived copy of the old site. Walk in with something he lost
- [ ] **Open the next call with three questions, in this order:** (1) is this your business / are you the owner; (2) who was the old website with and what was the address; (3) how many jobs a week are you doing now, and are you turning any away
- [ ] **Decide the monthly number before dialing.** He told us $30–40. Price at or above it, bundle hosting and management, and make "it can never be taken down again" the explicit reason the fee exists. Do not repeat *"you don't pay any monthly fees"*
- [ ] **Define the performance trial in writing** — what gets built, over how many days, what happens at the end, and what it costs. "We can make something happen" is not a term
- [ ] **CRM hygiene:** first name → Nathan · last name → leave blank and note it was never asked · assign owner to Randy · Source = cold SMS, nc-outreach / triad-part1 · add city Winston-Salem · verify the email with one send
- [ ] **Send the credentials text that was promised on Sep 15**
